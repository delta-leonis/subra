 ...
 */
@Value
public class RobotMeasurementsDeducer implements Deducer<DatagramPacket, RobotMeasurements.Supplier> {
  private final TeamColor color;

  @Override
  public Publisher<RobotMeasurements.Supplier> apply(
